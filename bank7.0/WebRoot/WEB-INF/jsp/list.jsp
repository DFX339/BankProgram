...
<body>
	<div class="net">
		...
		<div class="lunbo">
			<ul class='mainMenu1'>
				<li>
					<span class="first1"><a href="main.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px">余额显示界面</a></span><br/><br/>
				<h3>
 			<form action="return.do" method="post">
 			 	<input type="text" name="username" value="${user.username }" readonly="true" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:80px"/><br><br/>
 			 	<br>您的当前余额为：<input type="text" name="money" value="${money }" readonly="true" style="font-size:20px;height:32px;width:200px"/><br/><br/><br/>
 			 	<input type="submit" value="返回主界面" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:32px;width:120px "/>
 			 </form>
 		 	</h3>
