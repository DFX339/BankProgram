...
<body>
	<div class="net">
		...
		<div class="lunbo">
			<ul class='mainMenu1'>
				<li>
					<span class="first1"><a href="index.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px">出错界面</a></span><br/><br/>
				<h3>
 			SORRY，There is an unbelievable problem.Error<hr><br>
 			<h1>${exception.message }</h1>
 			<!-- struts自己处理的 异常信息-->
 		
 			
 		 	<a href="toLogin.do" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:20px">点击这里回到登录页面</a><br><br>
 		 	</h3>
