	...
	<div class="net">
		...
		<div class="lunbo">
			...
			<h4 style="color:red;">${exception.message }</h4><br>
 			<form action="inqury.do" method="post">
			  用户名： <input type="text" name="username" value="${user.username }" readonly="true" style="font-size:16px;width:200;height:32"/>
 			<input type="submit" name="inqury" value="查询余额" class="msg2"/>
 			</form> <br/>
 			
 			<form action="deposit.do" method="post">
 				请输入存款金额：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>
 			 	<input type="submit" name="deposit" value="存款"  class="msg2"/>
 			 </form> <br/>
 			 
 			 <form action="withdrawal.do" method="post">
 				请输入取款金额：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>
 			 	<input type="submit" name="withdrawal" value="取款"  class="msg2"/>
 			 </form><br/><hr><br>
 			
 			<form action="transfer.do" method="post">
 				转账对象ID：<input type="text" name="objId" style="font-size:16px;width:200;height:32" /><br><br>
 				转账金额：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>&nbsp;&nbsp;&nbsp;
 			 	<input type="submit" name="transfer" value="转账"  class="msg2"/>
 		 	</form>
 		 	</h3>
